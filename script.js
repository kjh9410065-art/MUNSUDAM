...
function previewDoc(id) {
  ...
  @page{size:A4;margin:0}*{box-sizing:border-box}body{margin:0 auto;width:210mm;max-width:210mm;min-height:297mm;padding:14mm;border:1.2px solid #222;color:#111;background:#fff;font-family:"Noto Sans KR","Malgun Gothic",Arial,sans-serif;font-size:13px;line-height:1.7}
